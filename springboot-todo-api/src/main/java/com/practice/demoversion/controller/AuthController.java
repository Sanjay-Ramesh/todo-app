...
import com.practice.demoversion.service.UserService;
import com.practice.demoversion.utils.JwtUtil;
...
public class AuthController {
    ...
    public ResponseEntity<?> loginUser(@RequestBody Map<String, String> body){
        ...
        if(userOptional.isEmpty()) {
            return new ResponseEntity<>("Register Your User First", HttpStatus.UNAUTHORIZED);
        }
